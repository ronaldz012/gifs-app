...
import SideMenuOption from '@layout/sidebar/side-menu-option/side-menu-option';
...
@Component({
  ...
  template: `
    @if (sidebarSvc.isOpen()) {
      <div class="fixed inset-0 bg-black/30 z-20 md:hidden" (click)="sidebarSvc.close()"></div>
    }
